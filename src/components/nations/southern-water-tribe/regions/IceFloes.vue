<template>
  <g>
    ...
    <path
      style="fill:none;stroke:#000000;stroke-width:5.6692915;stroke-linecap:butt;stroke-linejoin:bevel;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
      d="m 2099.3374,2159.1166 7.2638,-0.2945 2.0614,-1.0798 0.098,-1.4724 -1.276,-1.276 -36.1227,-13.0553 -3.3375,-0.3926 -2.2576,0.7853 -1.8651,0.9816 -0.4908,2.454 0.3927,2.8466 1.1779,4.4172 3.6319,7.8527 8.638,8.3436 4.1227,3.1411 6.5767,-7.1656 5.6933,-4.1227 z"
      id="path884"
      inkscape:connector-curvature="0"/>
  </g>
</template>
